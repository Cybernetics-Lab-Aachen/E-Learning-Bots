...
public class Test {
	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException {
		...
		JSONObject json = new JSONObject(
				"{    \"status\": \"OK\",    \"warningMessage\": \"certain-operations-excluded-due-to-unsupported-text-language\",    \"usage\": \"By accessing AlchemyAPI or using information generated by AlchemyAPI, you are agreeing to be bound by the AlchemyAPI Terms of Use: http://www.alchemyapi.com/company/terms.html\",    \"url\": \"http://www.spiegel.de/einestages/thema/fotografie/\",    \"totalTransactions\": \"4\",    \"language\": \"german\",    \"concepts\": [ ],    \"entities\": [        {            \"count\": \"1\",            \"relevance\": \"0.949678\",            \"sentiment\": {                \"score\": \"0\",                \"type\": \"neutral\"            },            \"text\": \"Steve Jobs\",            \"type\": \"Person\"        },        {            \"count\": \"1\",            \"relevance\": \"0.942607\",            \"sentiment\": {                \"score\": \"0\",                \"type\": \"neutral\"            },            \"text\": \"Andy Warhol\",            \"type\": \"Person\"        },        {            \"count\": \"1\",            \"relevance\": \"0.885994\",            \"sentiment\": {                \"score\": \"0\",                \"type\": \"neutral\"            },            \"text\": \"Von Christoph Gunkel\",            \"type\": \"Person\"        }    ],    \"keywords\": [        {            \"relevance\": \"0.957799\",            \"sentiment\": {                \"score\": \"0.102778\",                \"type\": \"positive\"            },            \"text\": \"SPIEGEL ONLINE 21\"        },        {            \"relevance\": \"0.94657\",            \"sentiment\": {                \"type\": \"neutral\"            },            \"text\": \"Solveig Grothe\"        },        {            \"relevance\": \"0.909667\",            \"sentiment\": {                \"type\": \"neutral\"            },            \"text\": \"SPIEGEL ONLINE 07\"        }    ]}");
		...
		System.out.println("Entities : " + entArray.length);
		...
		System.out.println("Keywords : " +keyArray.length);
		...
		System.out.println("Concepts : " + conArray.length);
